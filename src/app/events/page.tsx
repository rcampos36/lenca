export const metadata = {
  title: "Events | LENCA",
  description: "Private dining, wine evenings, and special events at LENCA.",
};
    ...
    <main className="min-h-screen bg-[#111] pt-32 pb-24 px-6 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-8 font-barlow text-lg text-[#a39e94] max-w-2xl mx-auto">
          Host your next celebration with us. Private dining, wine evenings, and seasonal events—contact us to plan your gathering.
        </p>
      </div>
    </main>
  );
